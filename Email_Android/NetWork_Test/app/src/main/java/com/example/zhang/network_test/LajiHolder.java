...
public class LajiHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public LajiHolder(LayoutInflater inflater, ViewGroup parent)
    {
