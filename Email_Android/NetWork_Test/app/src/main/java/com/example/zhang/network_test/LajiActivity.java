...
public class LajiActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        url="http://112.74.176.171:8080/NetWork_test/Servlet/LajiServlet?uid="+u1.getUid();
        text_title.setText("垃圾箱");
        mEmails = new ArrayList<>();
        Adapter = new LajiAdapter(mEmails, this);
